/************************************************************************************//**
* \file         Source/ARMCM4_XMC4/mbrtu.c
...
#endif
#if defined(USIC2)
  XMC_UART2_CH0, /* BOOT_COM_MBRTU_CHANNEL_INDEX = 4 */
  XMC_UART2_CH1  /* BOOT_COM_MBRTU_CHANNEL_INDEX = 5 */
#endif
};
...
void MbRtuInit(void)
{
   ...
   */
  ASSERT_CT((BOOT_COM_MBRTU_CHANNEL_INDEX >= 0) && (BOOT_COM_MBRTU_CHANNEL_INDEX <= 5));
