/************************************************************************************//**
* \file         Demo/ARMCM3_STM32L1_Nucleo_L152RE_IAR/Boot/blt_conf.h
* \brief        Bootloader configuration header file.
* \ingroup      Boot_ARMCM3_STM32L1_Nucleo_L152RE_IAR
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
...
#define BOOT_CPU_SYSTEM_SPEED_KHZ        (32000)
...
****************************************************************************************/
/** \brief This microcontroller has a smaller vector table then the default STM32L1xx
 ...
 */
#define BOOT_FLASH_VECTOR_TABLE_CS_OFFSET (0x124)
