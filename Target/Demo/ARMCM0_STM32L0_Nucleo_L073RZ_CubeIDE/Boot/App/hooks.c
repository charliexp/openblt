/************************************************************************************//**
* \file         Demo/ARMCM0_STM32L0_Nucleo_L073RZ_CubeIDE/Boot/App/hooks.c
* \brief        Bootloader callback source file.
* \ingroup      Boot_ARMCM0_STM32L0_Nucleo_L073RZ_CubeIDE
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
...
#include "stm32l0xx.h"                           /* STM32 registers and drivers        */
#include "stm32l0xx_ll_gpio.h"                   /* STM32 LL GPIO header               */
