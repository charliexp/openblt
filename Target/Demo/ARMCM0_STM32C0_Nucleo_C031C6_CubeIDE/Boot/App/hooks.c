/************************************************************************************//**
* \file         Demo/ARMCM0_STM32C0_Nucleo_C031C6_CubeIDE/Boot/App/hooks.c
* \brief        Bootloader callback source file.
* \ingroup      Boot_ARMCM0_STM32C0_Nucleo_C031C6_CubeIDE
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
...
#include "stm32c0xx_ll_gpio.h"                   /* STM32 LL GPIO header               */
