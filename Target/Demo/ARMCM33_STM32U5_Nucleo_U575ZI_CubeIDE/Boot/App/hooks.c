/************************************************************************************//**
* \file         Demo/ARMCM33_STM32U5_Nucleo_U575ZI_CubeIDE/Boot/App/hooks.c
* \brief        Bootloader callback source file.
* \ingroup      Boot_ARMCM33_STM32U5_Nucleo_U575ZI_CubeIDE
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
...
#include "stm32u5xx.h"                           /* STM32 registers and drivers        */
#include "stm32u5xx_ll_gpio.h"                   /* STM32 LL GPIO header               */
