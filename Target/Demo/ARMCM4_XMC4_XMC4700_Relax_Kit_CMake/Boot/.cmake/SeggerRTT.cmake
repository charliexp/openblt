...
target_sources(segger_rtt INTERFACE
    "${CMAKE_SOURCE_DIR}/lib/segger/rtt/RTT/SEGGER_RTT.c"
    "${CMAKE_SOURCE_DIR}/lib/segger/rtt/RTT/SEGGER_RTT_printf.c"
    "${CMAKE_SOURCE_DIR}/lib/segger/rtt/Syscalls/SEGGER_RTT_Syscalls_GCC.c"
)

target_include_directories(segger_rtt INTERFACE 
    "${CMAKE_SOURCE_DIR}/lib/segger/rtt/Config"
    "${CMAKE_SOURCE_DIR}/lib/segger/rtt/RTT"
)
