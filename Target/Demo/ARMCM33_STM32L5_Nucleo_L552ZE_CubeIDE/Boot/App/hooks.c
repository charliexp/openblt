/************************************************************************************//**
* \file         Demo/ARMCM33_STM32L5_Nucleo_L552ZE_CubeIDE/Boot/App/hooks.c
* \brief        Bootloader callback source file.
* \ingroup      Boot_ARMCM33_STM32L5_Nucleo_L552ZE_CubeIDE
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
...
#include "stm32l5xx_ll_gpio.h"                   /* STM32 LL GPIO header               */
